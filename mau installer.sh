...
echo -b "Mau Installer $green " | lolcat
...
sleep 1
echo -b $green"[#]> lu Goblok dan luTolol. Itu panggilanku" |lolcat

echo -b $green"[#]> Pilih Tools Yang Mau Lu Install Boss" ||olcat
figlet "Mau@Installer" | lolcat
sleep 1
exit
}
...
echo -e "[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]+" | lolcat
echo -e "HITAM PUTIH TERGANTUNG ANDA"
read -p "Mau@Installer" pil;
...
00) echo "Terimakasih Sudah Menggunakan Tools ini" | lolcat
echo "WE ARE PANDA7w7" | lolcat
echo "WE ARE FAMILY" | lolcat
echo "Merendahlah Agar Tiada Satupun Dapat Merendahkan" | lolcat
echo "Mengalahlah Agar Tiada Satupun Dapat Mengalahkan" | lolcat
figlet itsR03D17w7 | lolcat
exit
;;

*) echo "Ingin di Recode? Ijin dulu. Untuk menghargai authornya"
esac
done
done